...
import com.satist.overscroll.OverScrollLayout;
...
public abstract class SimpleComponent extends RelativeLayout implements RefreshComponent {
    ...
    public SpinnerStyle getSpinnerStyle() {
        ...
        if (mWrappedView != null) {
            ...
            if (params instanceof OverScrollLayout.LayoutParams) {
                mSpinnerStyle = ((OverScrollLayout.LayoutParams) params).spinnerStyle;
                if (mSpinnerStyle != null) {
                    return mSpinnerStyle;
                }
            }
    ...
    public void onInitialized(@NonNull RefreshKernel kernel, int height, int maxDragHeight) {
        if (mWrappedInternal != null && mWrappedInternal != this) {
            ...
            ViewGroup.LayoutParams params = mWrappedView.getLayoutParams();
            if (params instanceof OverScrollLayout.LayoutParams) {
                kernel.requestDrawBackgroundFor(this, ((OverScrollLayout.LayoutParams) params).backgroundColor);
            }
        }
    }
