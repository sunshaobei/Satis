...
import com.satist.overscroll.util.ScrollUtil;
...
public class SimpleBoundaryDecider implements ScrollBoundaryDecider {
    ...
    public boolean canRefresh(View content) {
        ...
        return ScrollUtil.canRefresh(content, mActionEvent);
    }
    ...
    public boolean canLoadMore(View content) {
        ...
        return ScrollUtil.canLoadMore(content, mActionEvent, mEnableLoadMoreWhenContentNotFull);
    }
    //</editor-fold>
}
