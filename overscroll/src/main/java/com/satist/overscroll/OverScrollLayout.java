...
import static com.satist.overscroll.util.ScrollUtil.fling;
import static com.satist.overscroll.util.SizeUtil.dp2px;
import static com.satist.overscroll.util.SizeUtil.px2dp;
import static com.satist.overscroll.util.WidgetUtil.isContentView;
...
import com.satist.overscroll.api.RefreshContent;
...
import com.satist.overscroll.constant.DimensionStatus;
import com.satist.overscroll.constant.RefreshState;
import com.satist.overscroll.constant.SpinnerStyle;
import com.satist.overscroll.listener.DefaultRefreshFooterCreator;
import com.satist.overscroll.listener.DefaultRefreshHeaderCreator;
import com.satist.overscroll.listener.DefaultRefreshInitializer;
import com.satist.overscroll.listener.OnLoadMoreListener;
import com.satist.overscroll.listener.OnMultiListener;
import com.satist.overscroll.listener.OnRefreshListener;
import com.satist.overscroll.listener.OnRefreshLoadMoreListener;
import com.satist.overscroll.listener.OnStateChangedListener;
import com.satist.overscroll.listener.ScrollBoundaryDecider;
import com.satist.overscroll.simple.SimpleBoundaryDecider;
import com.satist.overscroll.interpolator.OverScrollInterpolator;
import com.satist.overscroll.wrapper.RefreshContentWrapper;
import com.satist.overscroll.wrapper.RefreshFooterWrapper;
import com.satist.overscroll.wrapper.RefreshHeaderWrapper;


@SuppressLint("RestrictedApi")
@SuppressWarnings({"unused"})
public class OverScrollLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent/*, NestedScrollingChild*/ {
    ...
    public OverScrollLayout(Context context, AttributeSet attrs) {
        ...
        if (!ta.hasValue(R.styleable.OverScrollLayout_android_clipToPadding)) {
            super.setClipToPadding(false);
        }
        if (!ta.hasValue(R.styleable.OverScrollLayout_android_clipChildren)) {
        ...
        mDragRate = ta.getFloat(R.styleable.OverScrollLayout_oslDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.OverScrollLayout_oslHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.OverScrollLayout_oslFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.OverScrollLayout_oslHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.OverScrollLayout_oslFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.OverScrollLayout_oslReboundDuration, mReboundDuration);
        mEnableLoadMore = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableLoadMore, mEnableLoadMore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.OverScrollLayout_oslHeaderHeight, mHeaderHeight);
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.OverScrollLayout_oslFooterHeight, mFooterHeight);
        mHeaderInsetStart = ta.getDimensionPixelOffset(R.styleable.OverScrollLayout_oslHeaderInsetStart, mHeaderInsetStart);
        mFooterInsetStart = ta.getDimensionPixelOffset(R.styleable.OverScrollLayout_oslFooterInsetStart, mFooterInsetStart);
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.OverScrollLayout_oslDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.OverScrollLayout_oslDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.OverScrollLayout_oslEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadMore = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableAutoLoadMore, mEnableAutoLoadMore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.OverScrollLayout_oslEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadMoreWhenContentNotFull = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableLoadMoreWhenContentNotFull, mEnableLoadMoreWhenContentNotFull);
        mEnableFooterFollowWhenNoMoreData = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenNoMoreData);
        mEnableFooterFollowWhenNoMoreData = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableFooterFollowWhenNoMoreData, mEnableFooterFollowWhenNoMoreData);
        mEnableClipHeaderWhenFixedBehind = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableClipHeaderWhenFixedBehind, mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableClipFooterWhenFixedBehind, mEnableClipFooterWhenFixedBehind);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.OverScrollLayout_oslFixedHeaderViewId, mFixedHeaderViewId);
        mFixedFooterViewId = ta.getResourceId(R.styleable.OverScrollLayout_oslFixedFooterViewId, mFixedFooterViewId);
        mHeaderTranslationViewId = ta.getResourceId(R.styleable.OverScrollLayout_oslHeaderTranslationViewId, mHeaderTranslationViewId);
        mFooterTranslationViewId = ta.getResourceId(R.styleable.OverScrollLayout_oslFooterTranslationViewId, mFooterTranslationViewId);
        mEnableNestedScrolling = ta.getBoolean(R.styleable.OverScrollLayout_oslEnableNestedScrolling, mEnableNestedScrolling);
        mNestedChild.setNestedScrollingEnabled(mEnableNestedScrolling);

        mManualLoadMore = mManualLoadMore || ta.hasValue(R.styleable.OverScrollLayout_oslEnableLoadMore);
        mManualHeaderTranslationContent = mManualHeaderTranslationContent || ta.hasValue(R.styleable.OverScrollLayout_oslEnableHeaderTranslationContent);
        mManualFooterTranslationContent = mManualFooterTranslationContent || ta.hasValue(R.styleable.OverScrollLayout_oslEnableFooterTranslationContent);
        mHeaderHeightStatus = ta.hasValue(R.styleable.OverScrollLayout_oslHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.OverScrollLayout_oslFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;

        int accentColor = ta.getColor(R.styleable.OverScrollLayout_oslAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.OverScrollLayout_oslPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
    ...
    /**
     * 重写 onFinishInflate 来完成 overscroll 的特定功能
    ...
    /**
     * 重写 onAttachedToWindow 来完成 overscroll 的特定功能
    ...
    protected void onAttachedToWindow() {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshContent == null) {
                ...
                errorView.setText(R.string.osl_content_empty);
    ...
    protected void onMeasure(final int widthMeasureSpec,final int heightMeasureSpec) {
        ...
        for (int i = 0, len = super.getChildCount(); i < len; i++) {
            ...
            if (child.getVisibility() == GONE || "GONE".equals(child.getTag(R.id.osl_tag))) {
                continue;
            }
...
//                        bottom = top + Math.max(Math.max(0, isEnableRefreshOrLoadMore(mEnableRefresh) ? mSpinner : 0) - lp.bottomMargin - lp.topMargin, 0);
    ...
    /**
     * 重写 onDetachedFromWindow 来完成 overscroll 的特定功能
     * 1.恢复原始状态
     * 2.清除动画数据 （防止内存泄露）
     */
    @Override
    protected void onDetachedFromWindow() {
        ...
        /*
         * 2020-5-27
         * https://github.com/scwang90/OverScrollRefreshLayout/issues/1166
         * 修复 Fragment 脱离屏幕再回到时，菊花转圈，无法关闭的问题。
         * overscroll 脱离屏幕时，必须重置状态，清空mHandler，否则动画等效果会导致 APP 内存泄露
         */
        ...
        /*
         * https://github.com/scwang90/overscrollRefreshLayout/issues/716
         * 在一些特殊情况下，当触发上拉加载更多后，
    ...
    /**
     * 重写 drawChild 来完成 overscroll 的特定功能
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
            ...
            if (contentView != null) {
                 ...
                 * 2019-12-24
                 * 修复 经典头拉伸状态下显示异常的问题
                 * 导致的原因 1.1.0 版本之后 overscroll 不推荐 Scale 模式，主推 FixedBehind 模式
    ...
    /**
     * 重写 computeScroll 来完成 overscroll 的特定功能
     * 1.越界回弹
     * 2.边界碰撞
     */
    @Override
                    ...
                    if (mDragDirection == 'v' || (Math.abs(dy) >= mTouchSlop && Math.abs(dx) < Math.abs(dy))) {//滑动允许最大角度为45度
                        ...
                        if (mIsBeingDragged) {
                            ...
                            if (parent instanceof ViewGroup) {
                                //修复问题 https://github.com/scwang90/OverScrollLayout/issues/580
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    if(notify) {
                        mRefreshListener.onRefresh(OverScrollLayout.this);
                    }
                } else if (mOnMultiListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    ...
                    mRefreshHeader.onStartAnimator(OverScrollLayout.this, mHeaderHeight,  maxDragHeight);
                }
                if (mOnMultiListener != null && mRefreshHeader instanceof RefreshHeader) {
                    if (notify) {
                        mOnMultiListener.onRefresh(OverScrollLayout.this);
                    }
                    final int maxDragHeight = (int)(mHeaderMaxDragRate < 10 ? mHeaderHeight * mHeaderMaxDragRate : mHeaderMaxDragRate);
        ...
        public void run() {
            if (animationRunnable == this && !mState.isFinishing) {
                ...
                if (Math.abs(velocity) >= 1) {
                    ...
                    animationRunnable = null;
                    if (Math.abs(mSpinner) >= Math.abs(mSmoothDistance)) {
                        int duration = 10 * Math.min(Math.max((int) px2dp(Math.abs(mSpinner-mSmoothDistance)), 30), 100);
    ...
    protected void moveSpinnerInfinitely(float spinner) {
        ...
        if (mEnableAutoLoadMore && !mFooterNoMoreData && isEnableRefreshOrLoadMore(mEnableLoadMore) && spinner < 0
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    if (mLoadMoreListener != null) {
                        mLoadMoreListener.onLoadMore(OverScrollLayout.this);
                    } else if (mOnMultiListener == null) {
                        finishLoadMore(2000);//如果没有任何加载监听器，两秒之后自动关闭
                    }
                    final OnLoadMoreListener listener = mOnMultiListener;
                    if (listener != null) {
                        listener.onLoadMore(OverScrollLayout.this);
                    }
                }
            }, mReboundDuration);
        }
...
//    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.OverScrollLayout_Layout);
            backgroundColor = ta.getColor(R.styleable.OverScrollLayout_Layout_layout_oslBackgroundColor, backgroundColor);
            if (ta.hasValue(R.styleable.OverScrollLayout_Layout_layout_oslSpinnerStyle)) {
                spinnerStyle = SpinnerStyle.values[ta.getInt(R.styleable.OverScrollLayout_Layout_layout_oslSpinnerStyle, SpinnerStyle.Translate.ordinal)];
            }
            ta.recycle();
        }
...
//                  mRefreshFooter.getView().requestLayout();
    ...
    /**
     * Set the Header's start offset（see oslHeaderInsetStart in the RepastPracticeActivity XML in demo-app for the practical application）.
     * 设置 Header 的起始偏移量（使用方法参考 demo-app 中的 RepastPracticeActivity xml 中的 oslHeaderInsetStart）
    ...
    /**
     * Set the Header's start offset（see oslHeaderInsetStart in the RepastPracticeActivity XML in demo-app for the practical application）.
     * 设置 Header 起始偏移量（使用方法参考 demo-app 中的 RepastPracticeActivity xml 中的 oslHeaderInsetStart）
     * @param insetPx 像素
     * @return RefreshLayout
     */
    @Override
...
//                      mKernel.setState(RefreshState.None);
                    ...
                    int startDelay = mRefreshHeader.onFinish(OverScrollLayout.this, success);
                    if (mOnMultiListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            if (mIsBeingDragged) {
                                ...
                                mTouchSpinner = 0;
                                mIsBeingDragged = false;
                                OverScrollLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop * 2, 0));
                                OverScrollLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
                            }
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                                OverScrollLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_UP, mLastTouchX, mLastTouchY, 0));
                                mNestedInProgress = false;
                                mTouchSpinner = 0;
                            }
                        }
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (count == 0) {
                    ...
                    final int startDelay = mRefreshFooter.onFinish(OverScrollLayout.this, success);
                    if (mOnMultiListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            if (mIsBeingDragged) {
                                ...
                                OverScrollLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offsetY + mTouchSlop * 2, 0));
                                OverScrollLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offsetY, 0));
                            }
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                                OverScrollLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_UP, mLastTouchX, mLastTouchY, 0));
        ...
        if (mState == RefreshState.None && isEnableRefreshOrLoadMore(mEnableRefresh)) {
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    ...
                    final View thisView = OverScrollLayout.this;
                    mLastTouchX = thisView.getMeasuredWidth() / 2f;
                    mKernel.setState(RefreshState.PullDownToRefresh);
                    ...
                    reboundAnimator.setDuration(duration);
                    reboundAnimator.setInterpolator(new OverScrollInterpolator(OverScrollInterpolator.INTERPOLATOR_VISCOUS_FLUID));
                    reboundAnimator.addUpdateListener(new AnimatorUpdateListener() {
                        @Override
                        public void onAnimationUpdate(ValueAnimator animation) {
...
//                            mRefreshFooter.getView().requestLayout();
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return OverScrollLayout.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
        //</editor-fold>
