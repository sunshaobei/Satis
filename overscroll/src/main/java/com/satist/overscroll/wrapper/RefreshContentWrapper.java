...
import static com.satist.overscroll.util.ScrollUtil.isTransformedTouchPointInView;
import static com.satist.overscroll.util.ScrollUtil.measureViewHeight;
import static com.satist.overscroll.util.ScrollUtil.scrollListBy;
...
import com.satist.overscroll.util.WidgetUtil;
...
public class RefreshContentWrapper implements RefreshContent, CoordinatorLayoutListener, AnimatorUpdateListener {
    ...
    protected void findScrollableView(View content, RefreshKernel kernel) {
        ...
        while (scrollableView == null || (scrollableView instanceof NestedScrollingParent
            ...
            if (!isInEditMode) {
                WidgetUtil.checkCoordinatorLayout(content, kernel, this);
            }
...
//            mBoundaryAdapter.setActionEvent(mMotionEvent);
    ...
    public void setUpComponent(RefreshKernel kernel, View fixedHeader, View fixedFooter) {
        ...
        if (fixedHeader != null || fixedFooter != null) {
            ...
            if (fixedHeader != null) {
                fixedHeader.setTag(R.id.osl_tag, "fixed-top");
            ...
            if (fixedFooter != null) {
                fixedFooter.setTag(R.id.osl_tag,"fixed-bottom");
