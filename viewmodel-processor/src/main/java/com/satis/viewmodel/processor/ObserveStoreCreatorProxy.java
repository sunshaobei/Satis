...
public class ObserveStoreCreatorProxy {
     ...
     MethodSpec.Builder storeMethod;
     private String mModuleName;
    public ObserveStoreCreatorProxy(String moduleName) {
    ...
    private void overrideMethod() {
        ...
        ParameterizedTypeName constructorParameterizedType =
                ParameterizedTypeName.get(constructorTypeName, observerTypeName.box());
        ParameterizedTypeName linkedHashMapType = ParameterizedTypeName.get(
    ...
    public void put( TypeElement typeElement) {
        ...
        ClassName className = ClassName.get(
                Processor.APT_PACKAGE+mModuleName,
                typeElement.getSimpleName().toString() + "$Observe"
        );
